...
(function($){
  ...
  theme.Variants = (function() {
    ...
    function Variants(options) {
      ...
      // SS_2020
      this._setVariantInfo(this.currentVariant);
    ...
    Variants.prototype = $.extend({}, Variants.prototype, {
      ...
      _setVariantInfo: function(variant) {
        try {
          ...
          if(!productTitle.innerText.includes("GIFT"))
          productTitle.innerHTML = productTitle.innerText + '<br> ' + variant.title + ' • ' + packInfo;
          ...
          console.log('Error with variant metafield setting:');
          console.log(err);
        }
      },
    ...
    AjaxCart.prototype = $.extend({}, AjaxCart.prototype, {
      ...
      buildCart: function(cart, openDrawer) {
        ...
        if (cart.items.length > 2) {
          ...
          this.$container.addClass(classes.hideWave);
        } else {
          this.$container.addClass(classes.staticDrawerElement);
          this.$container.removeClass(classes.hideWave);
        }
      ...
      _createItemList: function(cart) {
        return $.map(cart.items, function(item) {
          ...
          var packInfo = item.variant_title == 'Variety' ? '6-Pack' : '4-Pack';
  
          $(selectors.itemVariantTitle, $item).text(item.variant_title + ' • ' + packInfo);
  ...
  theme.headerNav = (function() {
    ...
    function headerLoad() {
      resizeLogo();
      // Thumb menu is disabled because we don't need it.
      // initStickyThumbMenu();
  ...
  theme.Product = (function() {
    ...
    Product.prototype = $.extend({}, Product.prototype, {
      ...
      updateVariantImage: function(evt) {
        ...
        var imageIndex = $('.product__slide[data-id="' + variant.featured_media.id + '"]').data('slick-index');
